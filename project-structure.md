...
└── src-tauri/                       # ── THE MACOS DESKTOP SHELL (Tauri 2) ──
    ...
    │   ├── icon.png / .icns / .ico  # App icon in platform formats (from `tauri icon`)
    │   ├── 32x32.png … 128x128@2x.png    # Size variants (generated)
    │   ├── android/  ios/           # Mobile launcher icons (generated boilerplate; unused in M1)
    │   ├── Square*.png, StoreLogo.png    # Windows Store sizes (generated boilerplate; unused)
